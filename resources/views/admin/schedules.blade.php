<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6" x-data="{ showAddSchedule: false, showActions: false }">
                
                <!-- Add Schedule Button -->
                <button @click="showAddSchedule = !showAddSchedule" class="mb-4 px-4 py-2 bg-indigo-600 text-white rounded-md">
                    <span x-text="showAddSchedule ? 'Hide Add Schedule' : 'Add Schedule'"></span>
                </button>

                <!-- Add Schedule Form -->
                <div x-show="showAddSchedule" class="mb-6">
                ...
                <button @click="showActions = !showActions" class="mb-4 px-4 py-2 bg-indigo-600 text-white rounded-md">
                    <span x-text="showActions ? 'Hide Actions' : 'Show Actions'"></span>
                </button>
                    ...
                    <tbody>
                        @foreach ($balangaToMarivelesSchedules as $schedule)
                            <tr>
                                ...
                                <td class="border px-4 py-2 flex justify-between" x-show="showActions">
